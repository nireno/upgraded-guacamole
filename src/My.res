...
module Document = {
  type location
  @val @scope("document") external location: location = "location"
}

module URL = {
  type url
  type searchParams
  @new external makeURL: Document.location => url = "URL"
  @get external searchParams: url => searchParams = "searchParams"
  @send external getSearchParam: (searchParams, string) => Js.Nullable.t<string> = "get"
