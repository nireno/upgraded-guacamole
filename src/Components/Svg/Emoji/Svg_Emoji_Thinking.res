...
let make = () => {
  <svg
    ...
    <linearGradient
      ...
      <stop offset=".08" stopColor="#f7c02b" />
      <stop offset=".54" stopColor="#fde030" stopOpacity="0" />
    </linearGradient>
    <path
      d="M63.6 118.8c-27.9 0-58-17.5-58-55.9S35.7 7 63.6 7c15.5 0 29.8 5.1 40.4 14.4 11.5 10.2 17.6 24.6 17.6 41.5s-6.1 31.2-17.6 41.4c-10.6 9.3-25 14.5-40.4 14.5z"
      fill="url(#emoji-thinking-b)"
    />
    <path
    ...
    <radialGradient
      ...
      gradientUnits="userSpaceOnUse">
      <stop offset=".27" stopColor="#fff176" />
    ...
    />
    <path
      d="M76.87 71.31c-.32-.06-.62-.19-.87-.4a32.924 32.924 0 0 0-15.6-6.86c-5.71-.99-11.57-.45-17 1.56-.3.12-.62.16-.94.11-.7-.12-1.27-.64-1.46-1.33-.19-.68.04-1.4.58-1.85 10.6-8.8 26.32-7.34 35.12 3.26.72.87 1.38 1.79 1.98 2.74.38.59.38 1.35 0 1.94-.39.61-1.1.93-1.81.83zM80.77 31.11c4.19 0 8 3.54 8 9.42s-3.81 9.41-8 9.41c-4.19 0-8-3.54-8-9.41s3.81-9.42 8-9.42zM46.14 22c-4.19 0-8 3.54-8 9.41s3.81 9.42 8 9.42c4.2 0 8-3.54 8-9.42s-3.8-9.41-8-9.41zM39.73 10.63c-.45-.74-.51-1.66-.16-2.45.38-.79 1.13-1.33 2-1.44 5.45-.85 11.01.44 15.53 3.59 1.69 1.16 3.19 2.56 4.46 4.17.08.1.15.21.22.33.68 1.06.45 2.46-.53 3.25a2.75 2.75 0 0 1-3.6-.08l.42-.68-.51.6A25.46 25.46 0 0 0 42 12c-.95 0-1.83-.5-2.31-1.32l.04-.05zM93 28.52a2.65 2.65 0 0 0 1.34-2 2.59 2.59 0 0 0-1-2.24c-4.33-3.45-9.83-5.1-15.34-4.58-2.04.17-4.04.65-5.94 1.42l-.36.17c-1.11.59-1.6 1.92-1.14 3.09a2.743 2.743 0 0 0 3.15 1.7v-.8l.14.78c5.6-1.04 11.39-.17 16.44 2.47.83.47 1.84.47 2.67 0l.04-.01z"
      fill="#422b0d"
    />
    <path
