...
[@decco]
type roundSummary = {
  noti_maybeTeamHigh: option(( Team.id , Card.t)),
  noti_maybeTeamLow: option(( Team.id , Card.t)),
  noti_maybeTeamJack: option((Team.id, GameAward.jackAward)),
  noti_maybeTeamGame: option(( Team.id , int, int))
};
